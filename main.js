...
function create_fragment$2(ctx) {
	...
	arrow0 = new Arrow({
			props: {
				direction: "left",
				onClick: /*decrementDisplayedYear*/ ctx[5],
	...
	arrow3 = new Arrow({
			props: {
				direction: "right",
				onClick: /*incrementDisplayedYear*/ ctx[4],
				tooltip: "Next Year"
			}
		});
	...
	return {
		c() {
			...
			t5 = space();
			div0 = element("div");
			div0.textContent = `${/*todayDisplayStr*/ ctx[6]}`;
			t7 = space();
			...
			toggle_class(div2, "is-mobile", /*isMobile*/ ctx[7]);
		},
		m(target, anchor) {
			...
			append(div1, div0);
			append(div1, t7);
			mount_component(arrow2, div1, null);
			append(div1, t8);
			mount_component(arrow3, div1, null);
			current = true;
		...
		p(new_ctx, [dirty]) {
			...
			if (dirty & /*decrementDisplayedYear*/ 32) arrow0_changes.onClick = /*decrementDisplayedYear*/ ctx[5];
			arrow0.$set(arrow0_changes);
			const arrow1_changes = {};
			if (dirty & /*decrementDisplayedMonth*/ 8) arrow1_changes.onClick = /*decrementDisplayedMonth*/ ctx[3];
			arrow1.$set(arrow1_changes);
			const arrow2_changes = {};
			if (dirty & /*incrementDisplayedMonth*/ 4) arrow2_changes.onClick = /*incrementDisplayedMonth*/ ctx[2];
			arrow2.$set(arrow2_changes);
			const arrow3_changes = {};
			if (dirty & /*incrementDisplayedYear*/ 16) arrow3_changes.onClick = /*incrementDisplayedYear*/ ctx[4];
			arrow3.$set(arrow3_changes);
		},
		i(local) {
			if (current) return;
...
function instance$2($$self, $$props, $$invalidate) {
	...
	let { incrementDisplayedYear } = $$props;
	let { decrementDisplayedYear } = $$props;
	...
	$$self.$$set = $$props => {
		...
		if ("incrementDisplayedYear" in $$props) $$invalidate(4, incrementDisplayedYear = $$props.incrementDisplayedYear);
		if ("decrementDisplayedYear" in $$props) $$invalidate(5, decrementDisplayedYear = $$props.decrementDisplayedYear);
	};
...
class Nav extends SvelteComponent {
	constructor(options) {
		...
		init(this, options, instance$2, create_fragment$2, safe_not_equal, {
			...
			incrementDisplayedYear: 4,
			decrementDisplayedYear: 5
		});
	}
}
...
// (66:6) {#each month[1].days as date}
...
// (75:8) {#each daysOfWeek as dayOfWeek}
function create_each_block_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*daysOfWeek*/ 131072 && t_value !== (t_value = /*dayOfWeek*/ ctx[26] + "")) set_data(t, t_value);
		},
		d(detaching) {
			if (detaching) detach(th);
		}
...
function create_if_block(ctx) {
	...
	const weeknum_spread_levels = [
		/*week*/ ctx[20],
		{
			metadata: getWeeklyMetadata(/*sources*/ ctx[8], /*week*/ ctx[20].days[0], /*today*/ ctx[10])
		},
	...
	return {
		...
		p(ctx, dirty) {
			const weeknum_changes = (dirty[0] & /*month, sources, today, onClickWeek, onContextMenuWeek, onHoverWeek, selectedId*/ 67496)
			? get_spread_update(weeknum_spread_levels, [
					dirty[0] & /*month*/ 65536 && get_spread_object(/*week*/ ctx[20]),
					dirty[0] & /*sources, month, today*/ 66816 && {
						metadata: getWeeklyMetadata(/*sources*/ ctx[8], /*week*/ ctx[20].days[0], /*today*/ ctx[10])
					},
					dirty[0] & /*onClickWeek*/ 128 && { onClick: /*onClickWeek*/ ctx[7] },
					dirty[0] & /*onContextMenuWeek*/ 32 && {
						onContextMenu: /*onContextMenuWeek*/ ctx[5]
					},
					dirty[0] & /*onHoverWeek*/ 8 && { onHover: /*onHoverWeek*/ ctx[3] },
					dirty[0] & /*selectedId*/ 512 && { selectedId: /*selectedId*/ ctx[9] }
				])
			: {};
...
// (93:10) {#each week.days as day (day.format())}
function create_each_block_1(key_1, ctx) {
	...
	day = new Day({
			props: {
				...
				metadata: getDailyMetadata(/*sources*/ ctx[8], /*day*/ ctx[23], /*today*/ ctx[10]),
				selectedId: /*selectedId*/ ctx[9]
			}
		});
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			const day_changes = {};
			if (dirty[0] & /*month*/ 65536) day_changes.date = /*day*/ ctx[23];
			if (dirty[0] & /*today*/ 1024) day_changes.today = /*today*/ ctx[10];
			if (dirty[0] & /*displayedMonth*/ 1) day_changes.displayedMonth = /*displayedMonth*/ ctx[0];
			if (dirty[0] & /*onClickDay*/ 64) day_changes.onClick = /*onClickDay*/ ctx[6];
			if (dirty[0] & /*onContextMenuDay*/ 16) day_changes.onContextMenu = /*onContextMenuDay*/ ctx[4];
			if (dirty[0] & /*onHoverDay*/ 4) day_changes.onHover = /*onHoverDay*/ ctx[2];
			if (dirty[0] & /*sources, month, today*/ 66816) day_changes.metadata = getDailyMetadata(/*sources*/ ctx[8], /*day*/ ctx[23], /*today*/ ctx[10]);
			if (dirty[0] & /*selectedId*/ 512) day_changes.selectedId = /*selectedId*/ ctx[9];
			day.$set(day_changes);
		},
		i(local) {
			if (current) return;
...
// (81:6) {#each month as week (week.weekNum)}
function create_each_block(key_1, ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*month, today, displayedMonth, onClickDay, onContextMenuDay, onHoverDay, sources, selectedId*/ 67413) {
...
function create_fragment$7(ctx) {
	...
	nav = new Nav({
			props: {
				...
				incrementDisplayedYear: /*incrementDisplayedYear*/ ctx[13],
				decrementDisplayedYear: /*decrementDisplayedYear*/ ctx[14],
				resetDisplayedMonth: /*resetDisplayedMonth*/ ctx[15]
			}
		});

	let if_block0 = /*showWeekNums*/ ctx[1] && create_if_block_2();
	let each_value_3 = /*month*/ ctx[16][1].days;
	let each_blocks_2 = [];
	...
	return {
		...
		p(ctx, dirty) {
			const nav_changes = {};
			if (dirty[0] & /*today*/ 1024) nav_changes.today = /*today*/ ctx[10];
			...
			if (dirty[0] & /*month*/ 65536) {
				each_value_3 = /*month*/ ctx[16][1].days;
				let i;
			...
			if (dirty[0] & /*month, today, displayedMonth, onClickDay, onContextMenuDay, onHoverDay, sources, selectedId, onClickWeek, onContextMenuWeek, onHoverWeek, showWeekNums*/ 67583) {
...
function instance$7($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		if ("localeData" in $$props) $$invalidate(19, localeData = $$props.localeData);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*displayedMonth, localeData*/ 524289) {
			$$invalidate(16, month = getMonth(displayedMonth, localeData));
		}

		if ($$self.$$.dirty[0] & /*today, localeData*/ 525312) {
			$$invalidate(17, daysOfWeek = getDaysOfWeek(today, localeData));
		}
	};
...
class Calendar$1 extends SvelteComponent {
	constructor(options) {
		...
		init(
			...
			not_equal,
			{
				...
				incrementDisplayedYear: 13,
				decrementDisplayedYear: 14,
				resetDisplayedMonth: 15
			},
			[-1, -1]
		);
	}
	...
	get incrementDisplayedYear() {
		return this.$$.ctx[13];
	}

	get decrementDisplayedYear() {
		return this.$$.ctx[14];
	}
